...
from corriscope.common import async_to_sync, run_async
from corriscope.hardware.interfaces import TCPipe_BSB_MMI, FPGAMmi
...
class chFPGA(FPGAFirmware):
    ...
    def set_interface_ip_address(self):
        """Sets the IP address of the interface through which the host running corriscope
