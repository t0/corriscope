...
# corriscope.fpga_firmware.chfpga.chFPGA:  imported at runtime to prevent circular imports (chFPGA imports fpga_mmi)
...
class FPGAMmi(BSB_MMI):
    ...
    def _set_fpga_networking_parameters(
        ...
        import struct
        from corriscope.fpga_firmware.chfpga import chFPGA
